...
public class MenuEmplSalaryDept extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MenuEmplSalaryDept frame = new MenuEmplSalaryDept();
